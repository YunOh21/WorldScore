...
if __name__ == "__main__":
    ...
    with open("/home/ubuntu/WorldScore/calc/basic/droid_results_weird_first.jsonl", "w") as jsonl_file:
    ...
    df.to_csv("/home/ubuntu/WorldScore/calc/basic/droid_results_weird_first.csv", index=False)